...
namespace JokerApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View("Index", await _context.Joke.Where(j => j.JokerQuestion.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokerQuestion,JokerAnswer")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokerQuestion,JokerAnswer")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
